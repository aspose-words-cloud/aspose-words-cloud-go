...
**Compliance** | **string** | Gets or sets specifies the OOXML version for the output document. | [optional] [default to null]
**Password** | **string** | Gets or sets specifies a password to encrypt document using ECMA376 Standard encryption algorithm. | [optional] [default to null]
