...
**FalllbackFontName** | **string** | Gets or sets name of the font that will be used if no expected font is found in printer and built-in fonts collections. | [optional] [default to null]
**RasterizeTransformedElements** | **bool** | Gets or sets a value determining whether or not complex transformed elements should be rasterized before saving to PCL document.  Default is true. | [optional] [default to null]
